...
function extendMaterial(BaseMaterial, cfg) {
  ...
  // Use empty object if defines is undefined
  ...
  // cfg.vertex and cfg.fragment are objects with string keys and string values, not callable
  if (cfg.vertex && typeof cfg.vertex === 'object') {
    for (const [inc, code] of Object.entries(cfg.vertex)) {
      vert = vert.replace(inc, `${inc}\n${code}`);
    }
  }
  if (cfg.fragment && typeof cfg.fragment === 'object') {
